  ...
  return (
    <div className={`flex items-center justify-between min-w-full mt-4 mb-20 ${className}`}>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          <p className="text-sm text-gray-700">
            ...
            <select
              ...
              className="mt-2 bg-white shadow-sm rounded-md border-0 py-1.5 pl-2 text-gray-500 ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6 font-[400] ml-2"
            >
              {numberOfRows.map((el) => (
        ...
        <div>
          <nav className="flex items-center justify-between border-t border-gray-200 py-4 px-4 sm:px-0 space-x-3 w-full">
            <button
              onClick={() => handlePageChange(currentPage - 1)}
              disabled={currentPage <= 1}
            ...
            <div className="hidden md:flex space-x-3 items-center font-[400]">
